...
Output:
    analysis/tardis_options/data/btc_YYYY-MM-DD.parquet  (one file per day)
...
Usage:
    ...
    python -m analysis.tardis_options.fetch --from 2026-03-09 --to 2026-03-23 --keep-raw
"""
import argparse
import os
import sys
...
from analysis.tardis_options.download import download
from analysis.tardis_options.extract import extract
...
def fetch(
    ...
    disconnects:
        tmux new -s tardis
        TARDIS_API_KEY=... python -m analysis.tardis_options.fetch --from ... --to ...
...
Examples:
  python -m analysis.tardis_options.fetch --from 2026-03-09 --to 2026-03-23
  python -m analysis.tardis_options.fetch --from 2026-03-09 --to 2026-03-23 --max-dte 7
  TARDIS_API_KEY=YOUR_KEY python -m analysis.tardis_options.fetch --from 2026-03-09 --to 2026-03-23
        """,
    )
