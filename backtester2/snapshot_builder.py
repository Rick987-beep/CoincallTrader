...
tardis_options/data/ and produces two compact snapshot artifacts:
...
Both outputs are zstd-compressed Parquet files stored in snapshots/.

Usage:
    python -m backtester2.snapshot_builder
    python -m backtester2.snapshot_builder --data-dir path/to/data
    python -m backtester2.snapshot_builder --interval 5 --spot-interval 1
"""
import glob
import os
...
def build_snapshots(
    ...
    Args:
        data_dir: Path to raw tick parquets.
            Default: tardis_options/data/ relative to this file.
        output_dir: Output directory.
            Default: snapshots/ relative to this file.
...
if __name__ == "__main__":
    ...
    # Allow running from repo root: python -m backtester2.snapshot_builder
    # or directly: python backtester2/snapshot_builder.py
    ...
    parser.add_argument(
        ...
        help="Path to raw tick parquets (default: tardis_options/data/)",
    )
    parser.add_argument(
