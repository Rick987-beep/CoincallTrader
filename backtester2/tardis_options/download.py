...
Usage:
    ...
    python -m analysis.tardis_options.download 2026-03-09 --force
    python -m analysis.tardis_options.download 2026-03-09 --api-key YOUR_KEY

    # Recommended for multi-day runs (survives terminal disconnect):
    tmux new -s tardis
    TARDIS_API_KEY=... python -m analysis.tardis_options.fetch --from 2026-03-09 --to 2026-03-23
"""
import argparse
import os
import sys
