...
Usage:
    python -m backtester2.tickrecorder.recorder
...
from backtester2.tickrecorder.health import RecorderHealth, start_health_server
from backtester2.tickrecorder.instruments import InstrumentTracker
from backtester2.tickrecorder.snapshotter import Snapshotter
from backtester2.tickrecorder.ws_client import DeribitWSClient
...
async def _burst_snapshot_loop(snap, ws, health):
    ...
    while True:
        # Compute absolute UTC targets for this cycle
        now = time.time()
